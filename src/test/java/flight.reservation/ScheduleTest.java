...
public class ScheduleTest {
    ...
    class GivenAnEmptySchedule {
        ...
        void thenScheduleShouldYieldEmpty() {
            schedule.removeFlight(new Flight(1, new Airport("a", "a", "a"), new Airport("b", "b", "b"), new PassengerPlaneFactory().getPlaneType("A380")));
            assertEquals(0, schedule.getScheduledFlights().size());
        }
        ...
        class WhenAFlightIsScheduled {
            ...
            void scheduleOneFlight() {
                ...
                PassengerPlane aircraft = new PassengerPlaneFactory().getPlaneType("A380");
    ...
    class GivenAnExistingSchedule {
        ...
        List<Flight> flights = Arrays.asList(
                new Flight(1, airports.get(0), airports.get(1), new  PassengerPlaneFactory().getPlaneType("A350")),
                new Flight(2, airports.get(1), airports.get(2), new PassengerPlaneFactory().getPlaneType("A380")),
                new Flight(3, airports.get(2), airports.get(4), new PassengerPlaneFactory().getPlaneType("Embraer 190")),
                new Flight(4, airports.get(3), airports.get(2), new PassengerPlaneFactory().getPlaneType("Antonov AN2")),
