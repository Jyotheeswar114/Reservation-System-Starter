...
// all this code goes make reservation command
    ...
    public boolean cancelOrder(FlightOrder flightOrder){
        CancelReservationCommand cancel = new CancelReservationCommand(flightOrder);
        cancel.execute();
    }
